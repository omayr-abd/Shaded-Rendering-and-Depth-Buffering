...
public class Cylinder extends Shape{
	...
	private void fillMesh() {
		...
		for (i = 0, theta = v_min; i < m; ++i, theta += d_theta){
			...
			mesh.v[i][0] = new Vector3D(center.x,center.y,center.z+u_min);
			
			mesh.n[i][n-1] = new Vector3D(0,0,1);
			mesh.v[i][n-1] = new Vector3D(center.x,center.y,center.z+u_max);
		}
	}
}
